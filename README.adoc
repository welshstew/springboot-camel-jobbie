...
[source,bash,options="nowrap",subs="attributes+"]
----
$ mvn clean -DskipTests oc:deploy -Popenshift -Djkube.generator.fromMode=istag -D=jkube.generator.from=MY_PROJECT_NAME/fis-java-openshift:2.0
----
...
=== Pull in fuse7-java-openshift imagestream tags that don't exist

[source,bash,options="nowrap",subs="attributes+"]
----
oc tag registry.redhat.io/fuse7/fuse-java-openshift:1.8 fuse7-java-openshift:1.8
oc tag registry.redhat.io/fuse7/fuse-java-openshift:1.6 fuse7-java-openshift:1.6
----
...
=== Allow the App to create kubernetes/openshift jobs

[source,bash,options="nowrap",subs="attributes+"]
----
oc policy add-role-to-user edit system:serviceaccount:springboot:default -n springboot
----